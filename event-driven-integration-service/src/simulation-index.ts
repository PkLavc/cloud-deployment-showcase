...
import { mockDB, mockRedis, mockStripe, mockPayPal, mockGitHub } from '../mock-server';
...
app.post('/webhooks/stripe', express.raw({ type: 'application/json' }), async (req: express.Request, res: express.Response) => {
